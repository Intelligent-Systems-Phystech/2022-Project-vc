...
% Третий слайд: нужно отобразить суть. Важно доставить свой massage до слушателей.Еще было бы круто ввести термины и основные обозначения

% Под каждым графиком -- что мы видим и какой вывод
